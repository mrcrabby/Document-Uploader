...
(function ($) {
    ...
    UploadHandler = function (container, options) {
        ...
        this.onLoad = function (event, files, index, xhr, handler) {
            ...
            //appends to dialog box
            $('.dialog-paragraph').append('The server is done processing your document and it is ready to be viewed. Check it out here:<br><a href="' + json.URL + '">' + json.URL + '</a>');
            //opens dialog box
            $('#dialog').dialog('open');
